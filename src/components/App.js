...
class App extends Component {
  ...
  async loadBlockchainData() {
    ...
    const daiTokenAddress = "0xa14aFb98103a7af8b0FC294AA7206baD81792fFF" // Replace DAI Address Here
      ...
      <div>
        <nav className="navbar navbar-dark fixed-top bg-dark flex-md-nowrap p-0 shadow">
          <a
            ...
            href="https://www.linkedin.com/in/nishant-guvvada-36647289/"
            target="_blank"
            rel="noopener noreferrer"
          >
            Blockchain Wallet - Nishant Guvvada
          </a>
        </nav>
        <div className="container-fluid mt-5">
          <div className="row">
            <main role="main" className="pt-50 col-lg-12 d-flex text-center">
              <div className="content mr-auto ml-auto" style={{ width: "500px" }}>
                <a
                  ...
                  rel="noopener noreferrer"
                >
                  <img src={daiLogo} alt="logo" width="150" />
                </a>
